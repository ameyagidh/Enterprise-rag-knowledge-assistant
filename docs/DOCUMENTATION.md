# 📚 Enterprise RAG Knowledge Assistant — Documentation
...
> 📖 **Want the full story?** [`docs/PROJECT_OVERVIEW.md`](PROJECT_OVERVIEW.md) documents every bug fixed, every design decision, the full testing strategy, and the exact end-to-end verification performed on this build.
...
![Streamlit UI on startup](screenshots/streamlit_ui_raw.png)
...
![Grounded chat answer with citations](screenshots/streamlit_grounded_answer.png)
...
![Ungrounded fallback response](screenshots/streamlit_ungrounded_answer.png)
